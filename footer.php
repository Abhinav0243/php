						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Varanasi</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>9876543221</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>abhinavsingh8853@gmail.com</a></li>
								</ul>
							</div>
						</div>
